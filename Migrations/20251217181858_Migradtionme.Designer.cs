...
namespace TestingPlatform.Infrastructure.Migrations
{
    ...
    [Migration("20251217181858_Migradtionme")]
    partial class Migradtionme
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TestingPlatform.Domain.Models.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("TestingPlatform.Domain.Models.UserSelectedOption", b =>
                {
                    ...
                    b.Property<int?>("UserTextAnswerId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("TestingPlatform.Domain.Models.UserAttemptAnswer", b =>
                {
                    b.HasOne("TestingPlatform.Domain.Models.Attempt", "Attempts")
                        .WithMany("UserAttemptAnswers")
                        .HasForeignKey("AttemptId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TestingPlatform.Domain.Models.Question", "Questions")
                        .WithMany("UserAttemptAnswers")
                        .HasForeignKey("QuestionId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("TestingPlatform.Domain.Models.UserSelectedOption", b =>
                {
                    ...
                    b.HasOne("TestingPlatform.Domain.Models.UserTextAnswer", "UserTextAnswer")
                        .WithMany()
                        .HasForeignKey("UserTextAnswerId");
